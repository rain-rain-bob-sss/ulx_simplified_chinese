...
client.catList.OnRowSelected = function(self, LineID, Line)
    ...
    if nPanel ~= client.curPanel then
        ...
        xlib.addToAnimQueue("pnlSlide",
            { panel = nPanel, startx = -435, starty = 0, endx = 0, endy = 0, setvisible = true })
        ...
        xlib.addToAnimQueue("pnlSlide",
            { panel = nPanel, startx = 0, starty = 0, endx = -435, endy = 0, setvisible = false })
        self:ClearSelection()
        client.curPanel = nil
        xlib.animQueue_start()
    end
...
xlib.makebutton { x = 5, y = 307, w = 150, label = "保存客户端设置", parent = client }.DoClick = function()
...
genpnl.pickupplayers = xlib.makecheckbox { x = 10, y = 10, w = 150, label = "可使用物理枪抬起玩家 (仅为自己启用)", convar =
"cl_pickupplayers", parent = genpnl }
...
xgui.addSubModule("通常设置", genpnl, nil, "client")
...
xguipnl.upbtnM = xlib.makebutton { x = 250, y = 120, w = 20, icon = "icon16/bullet_arrow_up.png", centericon = true, disabled = true, parent =
    xguipnl }
...
xguipnl.downbtnM = xlib.makebutton { x = 270, y = 120, w = 20, icon = "icon16/bullet_arrow_down.png", centericon = true, disabled = true, parent =
    xguipnl }
...
xguipnl.settingorder:AddColumn("设置模块")
...
xguipnl.upbtnS = xlib.makebutton { x = 395, y = 120, w = 20, icon = "icon16/bullet_arrow_up.png", centericon = true, disabled = true, parent =
    xguipnl }
...
xguipnl.downbtnS = xlib.makebutton { x = 375, y = 120, w = 20, icon = "icon16/bullet_arrow_down.png", centericon = true, disabled = true, parent =
    xguipnl }
...
--XGUI POSITIONING--
--------------------
xlib.makelabel { x = 175, y = 145, label = "XGUI位置:", parent = xguipnl }
...
xguipnl.b8 = xlib.makebutton { x = 195, y = 160, w = 20, icon = "icon16/arrow_up.png", centericon = true, disabled = pos ==
    8, parent = xguipnl }
...
xguipnl.b4 = xlib.makebutton { x = 175, y = 180, w = 20, icon = "icon16/arrow_left.png", centericon = true, disabled =
    pos == 4, parent = xguipnl }
xguipnl.b4.DoClick = function(self) xguipnl.updatePos(4) end
xguipnl.b5 = xlib.makebutton { x = 195, y = 180, w = 20, icon = "icon16/bullet_green.png", centericon = true, disabled =
    pos == 5, parent = xguipnl }
xguipnl.b5.DoClick = function(self) xguipnl.updatePos(5) end
xguipnl.b6 = xlib.makebutton { x = 215, y = 180, w = 20, icon = "icon16/arrow_right.png", centericon = true, disabled =
    pos == 6, parent = xguipnl }
...
xguipnl.b2 = xlib.makebutton { x = 195, y = 200, w = 20, icon = "icon16/arrow_down.png", centericon = true, disabled =
    pos == 2, parent = xguipnl }
...
xlib.makelabel { x = 300, y = 195, label = "Y坐标", parent = xguipnl }
