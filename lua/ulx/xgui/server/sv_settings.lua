...
function settings.init()
    ULib.ucl.registerAccess("xgui_gmsettings", "superadmin", "允许在 XGUI 的设置选项卡上更改特定于游戏模式的设置.", "XGUI")
    ULib.ucl.registerAccess("xgui_svsettings", "superadmin", "允许在 XGUI 的设置选项卡上更改服务器和 ULX 特定的设置.", "XGUI")
